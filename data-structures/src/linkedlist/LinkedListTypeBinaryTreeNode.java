...
public class LinkedListTypeBinaryTreeNode {
	...
	public LinkedListTypeBinaryTreeNode() {
		head = null;
	}

	public void insert(BinaryTreeNode data, int position) {
	...
	public void append(BinaryTreeNode data) {
		Node newNode = new Node(data);
		Node currentNode = head;
		if (head != null) {
	...
	public BinaryTreeNode getElementAtPosition(int position) {
